            ...
            <div class="sidebar text-center bg-gray-900">
                ...
                <a href="{{ route('admin/products') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Produk</span>
                    </div>
                </a>
                ...
                <a href="{{ route('admin/contact') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Pesan Masuk</span>
                    </div>
                </a>
                ...
                <a href="{{ route('sewa.index') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Data Sewa</span>
                    </div>
                </a>
